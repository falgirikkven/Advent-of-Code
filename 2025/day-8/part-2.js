...
function solve() {
  ...
  let result = jbPositions[last.id[0]].x * jbPositions[last.id[1]].x;

  console.log("Part Two", result);
  // Expected output: 8199963486
}
...
function connectAllJunctionBoxes(junctionBoxes) {
  let lastConnected;
